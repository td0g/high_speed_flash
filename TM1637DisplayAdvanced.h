...
#ifndef __TM1637DISPLAYADVANCED__
#define __TM1637DISPLAYADVANCED__
...
public:
  ...
  //! if set to true, display will flip
  void setInverted(uint8_t invert);
  
  //! Set state of an individual segment
  //! pos, 0 = leftmost
  //! updates display immediately
  void setSegmentState(uint8_t digit, uint8_t high = 255, uint8_t low = 255);

  //! Clears set states of all segment
  //! updates display immediately
...
protected:
   ...
   bool writeByte(uint8_t b, bool inverted = 0);
...
private:
 ...
 uint8_t m_digitMask = 0b00001111;
 uint8_t m_segmentsHigh[4] = {0, 0, 0, 0};
 uint8_t m_segmentsLow[4] = {255, 255, 255, 255};
};

#endif // __TM1637DISPLAYADVANCED__
